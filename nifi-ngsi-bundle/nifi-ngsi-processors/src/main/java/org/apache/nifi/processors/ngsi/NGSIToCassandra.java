...
import org.apache.nifi.processors.ngsi.ngsi.backends.CassandraBackend;
...
public class NGSIToCassandra extends AbstractCassandraProcessor {
    ...
    private final static List<PropertyDescriptor> propertyDescriptors = Collections.unmodifiableList(Arrays.asList(
            CONNECTION_PROVIDER_SERVICE, NGSI_VERSION, DATA_MODEL , ATTR_PERSISTENCE,DEFAULT_SERVICE,DEFAULT_SERVICE_PATH,ENABLE_ENCODING, ENABLE_LOWERCASE,CONTACT_POINTS, KEYSPACE, TABLE, CLIENT_AUTH, USERNAME, PASSWORD,
